...
export const UseMode = () => {
    ...
    const UiFont = JSON.parse(localStorage.getItem("system.settings")) || "'Plus Jakarta Sans', sans-serif";
    ...
    useEffect(() => {
        localStorage.setItem("system.settings", JSON.stringify(appSettings));
    }, [appSettings]);
